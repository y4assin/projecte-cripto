...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="{{route('dashboard')}}"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
                            viewBox="0 0 512 512">
                        ...
                        </svg> <span>CryptoCurrency</span></a></li>
                <li><a href="{{route('exchanges.index')}}"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
                            viewBox="0 0 512 512">
                            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path
